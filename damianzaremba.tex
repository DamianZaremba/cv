...
\item
  Worked with a multi-national team of people (50+) to accomplish build
  out in \textasciitilde{}10 hours and clean-up in \textasciitilde{}4
  hours for \textasciitilde{}23 rooms across the ULB campus.
\item
  Co-ordinated via Email, IRC, Twitter and Phone to provide assistance
  where required.
\end{itemize}
