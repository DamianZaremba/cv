...
low latency/real time), solution design, testing, automation, Linux,
open source, monitoring, metrics and graphing.
...
Not interested in red tape or project management that gets in the way of
progress.
